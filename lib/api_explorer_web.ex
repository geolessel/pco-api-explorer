defmodule ApiExplorerWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ApiExplorerWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/api_explorer_web/templates",
                        namespace: ApiExplorerWeb
